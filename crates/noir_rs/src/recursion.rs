...
pub fn generate_recursive_honk_proof_artifacts(    
    ...
    Ok(unsafe {
        ...
        // In the case of the recursive circuit, this field is equal to 16 + the number of public inputs
        let num_public_inputs = usize::from_str_radix(proof[1].trim_start_matches("0x"), 16).unwrap() - 16;

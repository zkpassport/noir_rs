...
use crate::backends::barretenberg::utils::get_subgroup_size;
...
pub fn get_srs(circuit_bytecode: &str, srs_path: Option<&str>, recursive: bool) -> Srs {
...
pub fn setup_srs(circuit_bytecode: &str, srs_path: Option<&str>, recursive: bool) ->  Result<u32, String> {

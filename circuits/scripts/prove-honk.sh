...
time bb prove --scheme ultra_honk --write_vk --output_format bytes_and_fields -b ./target/$package_name.json -w ./target/${package_name}_witness.gz -o ./proofs/${package_name}_honk